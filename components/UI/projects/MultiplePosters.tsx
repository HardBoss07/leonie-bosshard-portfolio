...
import { graphicDesignImages } from "@/lib/images/graphicDesignImages";
  ...
  return (
    <div className="">
      <Poster
        ...
        alt={graphicDesignImages[2].alt}
      />

      <Poster
        url={graphicDesignImages[0].src}
        title="Beat Pulse"
        ...
        alt={graphicDesignImages[0].alt}
      />

      <Poster
        url={graphicDesignImages[1].src}

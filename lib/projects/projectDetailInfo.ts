...
export const projectData: Record<string, ProjectProps> = {
    ...
    pagerPrototype: {
        id: "pager-prototype",
        header2: "Pager Prototyp",
        projectTexts: [
            "Das Projekt entstand im Rahmen eines UX/UI-Designkurses und beschäftigte sich mit der Neugestaltung eines Feuerwehrpagers. Ziel war es, ausschliesslich Anpassungen an der bestehenden Hardware vorzunehmen, ohne in die vorhandenen technischen Systeme einzugreifen. Dadurch lag der Fokus besonders auf der optimalen Nutzung und Gestaltung der vorhandenen Strukturen.",
    ...
    productPhotography: {
        ...
        projectTexts: [
            ...
            "Bei der Gestaltung wurde bewusst mit klaren, reduzierten Hintergründen gearbeitet, um Ablenkungen zu vermeiden und die Aufmerksamkeit vollständig auf die Produkte zu lenken. Die Verwendung von Reflexionen und Wassertropfen unterstützt dabei den Eindruck von Frische, Qualität und Hochwertigkeit. Gleichzeitig verleiht dies den Bildern eine lebendige und dynamische Atmosphäre.",
